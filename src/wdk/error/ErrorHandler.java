 ...
 * inside of our program.  It's convenient to do this in one place so that we
 * have a common format for dealing with problems.
 * 
 * @author Brandon
 */
public class ErrorHandler {
    ...
    /**
     * Notes that this constructor is private and so can never be called
    ...
    /**
     * This method initializes this error handler's message dialog so that
     * it may provide feedback when errors occur.
     * 
    ...
    public void handleViewSummaryPageError(String pageURL) {
