 ...
 * occur.  Note that it always provides the same controls, a label with
 * a message, and a single ok button.  The release of Java version 40 
 * in March 2015 makes this class irrelevant because the Alert
 * class will do what this does and much more.
 * 
 * @author Brandon
 */
public class MessageDialog extends Stage {
    ...
    /**
     * Initializes this dialog so that it can be used repeatedly for all
     * kinds of messages.
     * 
