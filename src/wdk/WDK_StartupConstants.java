...
/**
 *This class stores all the constants used by the Wolfieball Draft Kit
 * application at startup, which means before the user interface is even loaded.
 * This mostly means how to find files for initializing the application, like
 * properties.xml.
 * 
 * @author Brandon
 */
